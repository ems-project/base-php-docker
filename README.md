...
```sh
make build-fpm PHP_VERSION=8.1.13
```

__Provide docker image__ : `docker.io/elasticms/base-php:8.1.13-fpm-prd`

## Example building __fpm__ variant __dev__ Docker image

```sh
make build-fpm-dev PHP_VERSION=8.1.13
```

__Provide docker image__ : `docker.io/elasticms/base-php:8.1.13-fpm-dev`

## Example building __nginx__ variant __dev__ Docker image

```sh
make build-nginx-dev PHP_VERSION=8.1.13
```

__Provide docker image__ : `docker.io/elasticms/base-php:8.1.13-nginx-dev`

## Example building __all__ variants Docker image

```sh
make build-all PHP_VERSION=8.1.13
```

__Provide docker images__ : 

- `docker.io/elasticms/base-php:8.1.13-fpm-prd`
- `docker.io/elasticms/base-php:8.1.13-fpm-dev`
- `docker.io/elasticms/base-php:8.1.13-apache-prd`
