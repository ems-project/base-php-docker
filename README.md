# Base Docker image [![Docker Build](https://github.com/ems-project/docker-php-fpm/actions/workflows/docker-build.yml/badge.svg?branch=8.2)](https://github.com/ems-project/docker-php-fpm/actions/workflows/docker-build-v2.yml)
