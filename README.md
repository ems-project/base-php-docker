# Base php-fpm Docker image [![Build Status](https://travis-ci.org/ems-project/docker-php-fpm.svg?branch=master)](https://travis-ci.org/ems-project/docker-php-fpm)
