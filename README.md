# Base Docker image [![Docker Build](https://github.com/ems-project/docker-php-fpm/actions/workflows/docker-build.yml/badge.svg?branch=8.0)](https://github.com/ems-project/docker-php-fpm/actions/workflows/docker-build-v2.yml)
...
```sh
make build-fpm PHP_VERSION=8.0.27 DOCKER_IMAGE_NAME=docker.io/lambdauser/mybasephpimage
```

__Provide docker image__ : `docker.io/lambdauser/mybasephpimage:8.0.27-fpm-prd`
