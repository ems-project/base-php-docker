# Base Docker image [![Docker Build](https://github.com/ems-project/docker-php-fpm/actions/workflows/docker-build.yml/badge.svg?branch=8.2)](https://github.com/ems-project/docker-php-fpm/actions/workflows/docker-build.yml)
...
- [`8.2.x-fpm`, `8.2-fpm`, `8.2.x-fpm-prd`, `8.2-fpm-prd`, `8.2.y-fpm-dev`, `8.2-fpm-dev`](Dockerfile)
- [`8.2.x-apache`, `8.2-apache`, `8.2.x-apache-prd`, `8.2-apache-prd`, `8.2.y-apache-dev`, `8.2-apache-dev`](Dockerfile)
- [`8.2.x-nginx`, `8.2-nginx`, `8.2.x-nginx-prd`, `8.2-nginx-prd`, `8.2.y-nginx-dev`, `8.2-nginx-dev`](Dockerfile)
- [`8.2.x-cli`, `8.2-cli`, `8.2.x-cli-prd`, `8.2-cli-prd`, `8.2.y-cli-dev`, `8.2-cli-dev`](Dockerfile)
...
This image is based and use the official PHP Docker Hub image [`docker.io/php:8.0.x-fpm-alpine3.16`](https://hub.docker.com/_/php) as parent.  
