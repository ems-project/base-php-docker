...
FROM php:${VERSION_ARG:-8.0.26}-fpm-alpine3.16 AS fpm-prd

LABEL be.fgov.elasticms.base.build-date=$BUILD_DATE_ARG \
      be.fgov.elasticms.base.name="Base PHP 8.0.x Docker Image" \
...
FROM php:${VERSION_ARG:-8.0.26}-cli-alpine3.16 AS cli-prd
